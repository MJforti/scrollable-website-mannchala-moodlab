    ...
    <header className="fixed top-0 inset-x-0 z-50 flex justify-center px-3 py-3 md:py-5 pointer-events-none">
      ...
      >
        ...
        <a href="#" className="font-semibold tracking-tighter text-xs md:text-sm uppercase text-white hover:opacity-80 transition-opacity flex items-center gap-2 shrink-0">
          ...
          <span className="text-[9px] font-mono text-zinc-400 bg-white/10 px-2 py-0.5 rounded-full hidden lg:inline-block">
            SOCIAL AGENCY
          </span>
        </a>
        ...
        <a
          href="#gear"
          className="group inline-flex items-center gap-1 rounded-full bg-white px-3.5 py-1.5 text-[11px] md:text-xs font-semibold text-zinc-950 transition-all duration-300 hover:bg-zinc-200 shrink-0"
        >
